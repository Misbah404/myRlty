  ...
  fn: async function (inputs, exits) {
    ...
    try {
     // const findOptions = await sails.helpers.getOptions.with({ searchFrom: ['name', 'email'], ...inputs });
      ...
      let avFrom = moment("2022-08-03"+" "+inputs.availability_from).utc().format('HH:mm:ss');
      let avTo = moment("2022-08-03"+" "+inputs.availability_to).utc().format('HH:mm:ss');
      ...
      const obj = {
        ...
        availability_from:avFrom,
        availability_to:avTo,
        bio:inputs.bio,
